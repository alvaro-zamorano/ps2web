...
export function startMetrics(playModule: any) {
  ...
  const metrics = { fps: 0, emuSpeedPct: 0, msPerFrame: 0, frameHash: null as number | null, threadsOk, cores, jitCompileMs: 0, jitBlocks: 0, blockDispatches: 0, chainMapEntries: 0, chainTableMismatches: -1, execMismatches: -1, fastMismatches: -1, stateHash: 0, stateHashAtN: 0, totalFrames: 0, ts: Date.now() };
  ...
  setInterval(() => {
    ...
    try { metrics.fastMismatches = playModule.getFastMismatches(); } catch (e) {}
